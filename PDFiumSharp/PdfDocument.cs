...
#pragma warning disable IDE0052 // Remove unread private members
        private readonly FPDF_FILEREAD fileRead;
#pragma warning restore IDE0052 // Remove unread private members
		...
		public IEnumerable<PdfBookmark> Bookmarks
		{
			get
			{
				FPDF_BOOKMARK handle = PDFium.FPDFBookmark_GetFirstChild(Handle, default);
				while (!handle.IsNull)
				{
        ...
        public PdfDocument(Stream stream, FPDF_FILEREAD fileRead, int count = 0, string password = null)
            : this(PDFium.FPDF_LoadDocument(stream, fileRead, count, password)) { this.fileRead = fileRead; }
